    ...
    <div className="min-h-screen bg-slate-50">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-4">
          ...
          {menuAberto && (
            <div id="menu-principal" className="border-t border-slate-200 py-3 sm:hidden">
              ...
              <div className="mt-3 flex flex-col gap-2 border-t border-slate-200 pt-3">
                <span className="px-3 text-sm text-slate-500">{usuario?.nome}</span>
                <button
                  onClick={aoEncerrarTodas}
                  disabled={encerrando}
                  className="rounded-md px-3 py-2 text-left text-sm text-slate-600 hover:bg-slate-100 disabled:opacity-60"
                >
                  {encerrando ? 'Encerrando...' : 'Sair de todos'}
                </button>
                <button
                  onClick={aoSair}
                  className="rounded-md border border-slate-300 px-3 py-2 text-left text-sm text-slate-600 hover:bg-slate-100"
                >
                  Sair
                </button>
              </div>
